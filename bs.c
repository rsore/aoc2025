...
generate_checksum_integrity_check(void)
{
    ...
    static const char *powershell_script_content =
        ...
        "    Write-Host \"All files are correct. Installation appears healthy!\" -ForegroundColor Green\n"
        "    Pop-Location\n"
        "    exit 0\n"
        "}\n"
        "\n"
        ...
        "}\n"
        "\n"
        "Write-Host \"    Installation appears CORRUPTED.\" -ForegroundColor Red\n"
        "Write-Host \"    Please re-verify your installation or reinstall.\" -ForegroundColor Red\n"
        "\n"
        "Pop-Location\n"
        "exit 1\n";
    ...
    const char *bash_script_content =
        ...
        "    echo \"All files are correct. Installation appears healthy!\"\n"
        "    exit 0\n"
        "fi\n"
        "\n"
        ...
        "echo\n"
        "echo \"    Installation appears CORRUPTED.\"\n"
        "echo \"    Please re-verify the installation or reinstall.\"\n"
        "\n"
        "exit 1\n";
